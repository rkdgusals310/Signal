...
public interface ArticleRepository extends JpaRepository<Article, Long> {
    ...
    void incrementViewCountById(Long articleId);
    ...
    @Transactional
    @Modifying
    @Query("UPDATE Article a SET a.likesCount = a.likesCount + 1 WHERE a.id = :articleId")
    void incrementLikesCountById(Long articleId);

    @Transactional
    @Modifying
    @Query("UPDATE Article a SET a.likesCount = a.likesCount - 1 WHERE a.id = :articleId")
    void decrementLikesCountById(Long articleId);
